...
const sourceIds = ['admin-dongs', 'facilities', 'transit', 'synthetic-contact-case']
const layerIds = ['dong-fill', 'dong-border', 'facility-clusters', 'facility-cluster-count', 'facility-points', 'transit-points', 'synthetic-contact-case-halo', 'synthetic-contact-case-point']
