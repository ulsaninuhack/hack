...
describe('P2 manager flow', () => {
  const breadth = {
    ...
    tuning_warning: { title: '합성 배점 튜닝 경고', current_mild_signal_count: 647, source_case_count: 5869, interpretation: '결정적 합성 시나리오의 배점 점검값입니다.' },
  ...
  it('shows the manager breadth API transfer queue, separated distributions, tuning warning, and 13 approved-visit hint', async () => {
    ...
    expect(screen.getByText('점수 규칙 점검값입니다.')).toBeInTheDocument()
