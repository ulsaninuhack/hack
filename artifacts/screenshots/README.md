...
| --- | --- | --- | --- |
| Surveyor queue | 390×844 | `surveyor-queue-mobile.png` | Worker-filtered queue with natural Korean display names |
...
| Manager map | 1440×900 | `manager-map-desktop.png` | Selected demo point and keyboard-list alternative |
| Public map | 1440×900 | `public-map-desktop.png` | Public aggregate map and exact mixed-snapshot warning |
| Public initial scenario | 1440×900 | `public-operations-scenario-desktop.png` | Fresh session, one fixed operating example for the selected current dong, and explicit source counts |
| Operations scenario evidence | 1440×900 | `operations-scenario-desktop.png` | Panel-top proof of the fixed operating example, reference date, and session/scenario/unrecorded counts |
| Operations overlay | 1440×900 | `operations-overlay-desktop.png` | Operations mode, separate map encodings, and unvalidated structural context |
